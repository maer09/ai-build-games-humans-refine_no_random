...
**输出**：`.<slug>/README.md`（核心机制、控制方式、对象规格、新颖性理由、标签记录、状态变量表、权衡说明）
...
**输出**：`.<slug>/VISUAL_DESIGN.md`（概念、调色板、渲染规格、效果设计）
...
**输出**：`.<slug>/SOUND_DESIGN.md`（概念、波形调色板、逐事件规格、动态参数）
